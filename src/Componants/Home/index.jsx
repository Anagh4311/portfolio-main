        ...
        <section name="Home" className="hero-container-main">
            <div className="hero-main">
                <div className="hero-text">
                    ...
                    <motion.p initial={{ y: -300 }} animate={{ y: 0 }} transition={{ type: "spring", stiffness: 100, delay: 0.3 }} className="ParaTxtColorDark">Hi, I'm Anagh Deshmukh. A passionate Front-end Developer. 📍</motion.p>
                ...
                <motion.div initial={{ y: -300, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ type: "spring", stiffness: 100, delay: 0.3 }} className="hero-img"></motion.div>
            </div>
